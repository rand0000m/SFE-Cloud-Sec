 ...
 */
package com.orange.cloudsec.cli.commands;
...
public class CloudSecCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(CloudSecCliTestCommand.class);
    protected final CloudSecCliCommands service;

    public CloudSecCliTestCommand(final CloudSecCliCommands service) {
